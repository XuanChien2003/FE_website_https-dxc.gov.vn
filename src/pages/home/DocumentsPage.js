...
const DocumentsPage = () => {
  ...
  return (
    <div className="bg-gov-bg-body font-sans text-gov-text text-[14px] pb-10 pt-[25px] min-h-screen">
      <div className="grid grid-cols-1 lg:grid-cols-[3fr_1fr] gap-[25px] max-w-[1300px] mx-auto px-4 lg:px-0">
        {/* --- CỘT TRÁI: MAIN CONTENT --- */}
        <div>
          {/* HEADER STYLE GIỐNG HOMEPAGE */}
          <div className="bg-gradient-to-r from-[#be1e2d] to-[#a01520] text-white py-2.5 px-[15px] border-t-[3px] border-gov-yellow font-bold uppercase text-[15px] flex items-center mb-0 rounded-t">
        ...
        <div>
          {/* BOX 1: WEBLINKS */}
          <div className="bg-white border border-gov-border shadow-[0_2px_5px_rgba(0,0,0,0.05)] mb-5">
            <div className="bg-gradient-to-r from-[#be1e2d] to-[#a01520] text-white py-2.5 px-[15px] border-t-[3px] border-gov-yellow font-bold uppercase text-[15px] flex items-center">
              <span>
                <FaLink style={{ marginBottom: "-2px", marginRight: "8px" }} /> LIÊN KẾT WEBSITE
              </span>
            </div>
          ...
          {/* BOX 2: VĂN BẢN MỚI */}
          <div className="bg-white border border-gov-border shadow-[0_2px_5px_rgba(0,0,0,0.05)] mb-5 mt-5">
            <div className="bg-gradient-to-r from-[#be1e2d] to-[#a01520] text-white py-2.5 px-[15px] border-t-[3px] border-gov-yellow font-bold uppercase text-[15px] flex items-center">
              <span>
                <FaStar style={{ marginBottom: "-2px", marginRight: "8px" }} /> VĂN BẢN MỚI
              </span>
            </div>
